...
<template>
  <CommonUnAuthNav /> 
  <div class="dark:bg-[#1e2328] flex items-center justify-center min-h-screen bg-white">
    <!-- <div
    ...
    <div
      class="relative flex flex-1 flex-col justify-center px-6 py-12 lg:w-2/5 lg:flex-none border-white/20 p-5 rounded-md"
    > 
      <div class="dark:bg-[#1e2328] relative mx-auto w-full max-w-sm bg-white">
        <!--Nav-->
