...
<!--     <div class="animated-bg flex-col w-full">
  ...
  <div class="dark:bg-dark bg-white">
    ...
    <CommonSectionsHero />
    <FrontendMarkets />
    <CommonSectionsPartnership />
    <CommonSectionsExploreProduct />
    <CommonSectionsContactUs />
    <CommonSectionsFooter />
  </div>

<!--       <div class="flex flex-col items-center bg-black">
        <CommonUnAuthNav /> 
        <CommonLandingHeroSection />
        <CommonLandingMarketSection />
        <CommonLandingSecuritySection />
        <CommonLandingFullyFeaturedSection v-if="isFeaturesVisible"/>
        <CommonLandingGetApp />
        <CommonLandingAboutUs />
        <CommonLandingDownoadApp />
        <CommonLandingFooter  v-if="isFooterVisible"/>
    </div> -->
<!--   </div> -->
</template>
